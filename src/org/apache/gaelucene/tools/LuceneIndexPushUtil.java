...
public class LuceneIndexPushUtil {
  ...
  public static void main(String[] args) throws IOException {
    ...
    SimpleFSDirectory sourceDir = new SimpleFSDirectory( new File(sourceDirName));
    
    if (!sourceDir.getDirectory().exists()) {
      System.err.println("'" + sourceDir.getDirectory().getAbsolutePath() + "' DOES NOT EXIST!");
      System.exit(-1);
    }
    sourceDirName = sourceDir.getDirectory().getAbsolutePath();
   ...
   /* BufferedWriter dataWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(jobRecFile,
    ...
    File[] files = sourceDir.getDirectory().listFiles();
