...
public class QueryParser implements QueryParserConstants {
   ...
   */
  public QueryParser(org.apache.lucene.util.Version version, String f, Analyzer a) {
...
//System.out.println("SimpleQueryParser.getFieldQuery() - t[" + t + "], t.getPositionIncrement:" + t.getPositionIncrement());
                                ...
                                boolean inclusive) throws ParseException
  {
    ...
    return new TermRangeQuery( field, part1,
                          part2,
                          inclusive,inclusive);
  }
...
// *   Clause ::= ["+", "-"] [<TERM> ":"] ( <TERM> | "(" Query ")" )
  ...
  final private int[] jj_la1_0 = {0x180,0x180,0xe00,0xe00,0xfb1f80,0x8000,0xfb1000,0x9a0000,0x40000,0x40000,0x8000,0xc000000,0x1000000,0xc000000,0x8000,0xc0000000,0x10000000,0xc0000000,0x8000,0x40000,0x8000,0xfb0000,};
