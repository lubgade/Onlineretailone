...
//System.out.println("[debug] - SimpleQueryParser.getFieldQuery - prepare PhraseQuery - " + t.termText());
          TermQuery tq = new TermQuery(new Term(field, t.term()));
...
///   }
  ...
  public static void main(String[] args) throws Exception {
    SimpleQueryParser qp = new SimpleQueryParser("field",
                           new org.apache.lucene.analysis.standard.StandardAnalyzer(org.apache.lucene.util.Version.LUCENE_34));
