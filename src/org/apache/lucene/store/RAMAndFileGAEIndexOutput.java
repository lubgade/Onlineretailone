 ...
 * @author kimchy
 */
public class RAMAndFileGAEIndexOutput extends IndexOutput  {
     ...
     */
    public static final long DEFAULT_THRESHOLD = 2000 * 1024;

    private long threshold;

    private RAMGAEIndexOutput ramIndexOutput;

    private FileGAEIndexOutput fileIndexOutput;

    private GAEDirectory gaeDirectory;
    ...
    public void configure(GAEDirectory directory, String fileName) throws IOException {
        ...
        ramIndexOutput = createRamGAEIndexOutput();
        ramIndexOutput.initBuffer(16384);
        ramIndexOutput.configure(directory,fileName);
    }
    ...
    private IndexOutput switchIfNeeded(int length) throws IOException {
        ...
        fileIndexOutput = createFileGAEIndexOutput();
        fileIndexOutput.configure(gaeDirectory,filename);
        fileIndexOutput.initBuffer(16384);
    ...
    protected FileGAEIndexOutput createFileGAEIndexOutput() {
        return new FileGAEIndexOutput();
    }

    protected RAMGAEIndexOutput createRamGAEIndexOutput() {
        return new RAMGAEIndexOutput();
    }
}
