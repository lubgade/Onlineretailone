...
if(resultCount > 0) { 
 ...
 Highlighter highlighter = new Highlighter(htmlFormater,queryScorer);
  for (int i=0; i < resultCount; i++) {
    ...
    String title=(doc.getFieldable("title") != null) ? doc.getFieldable("title").stringValue() : "";
    String content=(doc.getFieldable("content") != null) ? doc.getFieldable("content").stringValue() : "";
    String author=(doc.getFieldable("author") != null) ? doc.getFieldable("author").stringValue() : "";
    String pubtime=(doc.getFieldable("date") != null) ? doc.getFieldable("date").stringValue() : "";
	String titleshighlighted = highlighter.getBestFragment(analyzer, "title", title);
	if (titleshighlighted == null ) titleshighlighted =title;
	String contenthighlighted = highlighter.getBestFragment(analyzer, "content", content);
